            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        <img src="admin-placeholder.jpg" alt="Administrator" class="rounded-circle mb-3" width="150" height="150">
                        <h5 class="card-title">John Doe</h5>
                        <p class="card-text">John Doe is the administrator of this platform. With years of experience in managing digital platforms, John ensures everything runs smoothly and efficiently. His dedication to maintaining the highest standards makes him an invaluable part of our team.</p>
                        <p class="card-text">John is passionate about technology and helping local businesses thrive online. He believes in the power of digital transformation and is always looking for ways to innovate and improve the platform.</p>
                        <p class="card-text"><strong>Contact:</strong> admin@example.com</p>
                    </div>
                </div>
            </div>
         </div>
